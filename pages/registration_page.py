...
#         to interact with the registration form.
#     """
#     def __init__(self,page:Page): # CONSTRUCTOR for WEB ELEMENTS
#         self.page=page
#
#         # LOCATORS for REGISTRATION PAGE
#         self.txt_firstname=self.page.get_by_placeholder('First Name')
#         self.txt_lastname=self.page.get_by_placeholder('Last Name')
#         self.txt_email=self.page.get_by_placeholder('E-Mail')
#         self.txt_telephone=self.page.get_by_placeholder('Telephone')
#         self.txt_password=self.page.locator('#input-password')
#         self.txt_password_confirm=self.page.locator('#input-confirm')
#
#         self.txt_radio_button_yes=self.page.get_by_role("radio",name="Yes")
#         self.txt_radio_button_yes=self.page.get_by_role("radio",name="No")
#
#         self.chk_policy=self.page.locator('input[name="agree"]')
#         self.btn_continue=self.page.locator('input[value="Continue"]')
#
#         self.btn_continue_after_acc_creation=self.page.locator('.btn.btn-primary')
#
#         # Confirmation message (displayed after successful registration)
#         self.msg_confirmation = page.locator('h1:has-text("Your Account Has Been Created!")')
#
...
#         self.txt_password_confirm.fill(pwd)
#
#     def set_privacy_policy(self):
#         self.chk_policy.check()
#     def click_continue(self):
